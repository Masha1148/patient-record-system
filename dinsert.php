...
<body>
  ...
  <div class='input-form-box'>
    <form class='input-form' action='dinsert_con.php' method='post'>
      ...
      <textarea name='findings' placeholder='Write diagnosis' required></textarea><br>

      <label for='treatments'>Treatment Type</label>
      ...
      <label for='meds'>Medicines Prescription</label>
      <textarea name='meds' placeholder='If treatment is medication, write prescription here'></textarea><br>

      <label for='allerigies'>Referral</label>
      <textarea name='allergies' placeholder='Specialist'></textarea><br>

      <input type='submit' name='input-submit' value='Save'>
    </form>


    <div class='welcome'><h2 class='welcome_mssg'>If  Surgery Fill The Form</h2></div>
    <div class='input-form-box'>
